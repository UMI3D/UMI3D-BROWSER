...
namespace umi3d.browserRuntime.ui.dropdown
{
    ...
    public class DropdownLabelView : MonoBehaviour
    {
        TMP_Text _text;
        ...
        {
            if (notification.TryGetInfoT(DropdownNotificationKeys.DropdownSet.IsLabelVisible, out bool isActive))
            {
            ...
            if (notification.TryGetInfoT(DropdownNotificationKeys.DropdownSet.Label, out string newTitle))
            {
                _text.text = newTitle;
            }
        }
