...
{
    [RequireComponent(typeof(DropdownFactory)), ExecuteAlways]
    public class FormDropdownFactory : MonoBehaviour
    {
        private DropdownFactory _factory;

        private void Awake()
        {
            _factory = GetComponent<DropdownFactory>();
        }
