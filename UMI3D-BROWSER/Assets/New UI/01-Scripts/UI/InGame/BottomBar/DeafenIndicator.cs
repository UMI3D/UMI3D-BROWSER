...
namespace umi3d.browserRuntime.ui.inGame.bottomBar
{
    public class DeafenIndicator : MonoBehaviour
    {
        ...
        private void Awake()
        {
            NotificationHub.Default.Subscribe(this, InGameNotificationKeys.DeafenChanged, (Callback)DeafenChagned);
            NotificationHub.Default.Subscribe(this, SettingsNotificationKeys.SetDeafenIndicator, (Callback)Set);
