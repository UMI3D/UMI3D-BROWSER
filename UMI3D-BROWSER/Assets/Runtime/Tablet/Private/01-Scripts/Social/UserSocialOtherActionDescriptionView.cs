...
namespace umi3d.browserRuntime.ui.tablet.social
{
    ...
    public class UserSocialOtherActionDescriptionView : MonoBehaviour
    {
        TMP_Text _text;
        ...
        {
            if (notification.TryGetInfoT(UserSocialNotificationKeys.UserSocialOtherActionSet.Description, out string description))
            {
                _text.text = name;
            }
        }
