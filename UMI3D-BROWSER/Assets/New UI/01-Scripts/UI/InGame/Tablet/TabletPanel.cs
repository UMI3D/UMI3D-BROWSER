...
namespace umi3d.browserRuntime.ui.inGame.tablet
{
    public class TabletPanel : MonoBehaviour
    {
        private void Awake()
        {
            NotificationHub.Default.Subscribe(this, TabletNotificationKeys.Open, (Callback)Open);
            NotificationHub.Default.Subscribe(this, TabletNotificationKeys.Close, (Callback)Close);
