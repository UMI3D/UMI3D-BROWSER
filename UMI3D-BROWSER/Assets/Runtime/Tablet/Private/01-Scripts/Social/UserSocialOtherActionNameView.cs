...
namespace umi3d.browserRuntime.ui.tablet.social
{
    ...
    public class UserSocialOtherActionNameView : MonoBehaviour
    {
        TMP_Text _text;
        ...
        {
            if (notification.TryGetInfoT(UserSocialNotificationKeys.UserSocialOtherActionSet.Name, out string name))
            {
                _text.text = name;
            }
        }
