...
namespace umi3d.browserRuntime.ui.inGame.emote
{
    public class OpenEmoteButton : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            NotificationHub.Default.Subscribe(this, EmoteNotificationKeys.Open, (Callback)ShowBackground);
            NotificationHub.Default.Subscribe(this, EmoteNotificationKeys.Close, (Callback)HideBackground);
