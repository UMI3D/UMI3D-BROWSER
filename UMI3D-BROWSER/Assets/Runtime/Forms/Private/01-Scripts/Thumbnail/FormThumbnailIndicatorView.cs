...
namespace umi3d.browserRuntime.forms
{
    ...
    public class FormThumbnailIndicatorView : MonoBehaviour
    {
        ...
        {
            if (notification.TryGetInfoT(FormNotificationKeys.ThumbnailSet.IndicatorColor, out Color color, false))
            {
