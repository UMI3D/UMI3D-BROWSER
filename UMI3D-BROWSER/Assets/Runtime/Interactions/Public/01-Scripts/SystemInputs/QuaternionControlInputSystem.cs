...
{
    public class QuaternionControlInputSystem : NewInputSystem
    {
        public QuaternionControlInputSystem(QuaternionControl control) : base(control, InputActionType.PassThrough)
        {
        }
