...
public class WorldControllerModelTest
{
    ...
    public class AddTest: WorldControllerModelTest
    {
        [Test]
    ...
    public class RemoveTest: WorldControllerModelTest
    {
        [Test]
    ...
    public class UpdateTest: WorldControllerModelTest
    {
        [Test]
    ...
    public class ConnectionSucceeded: WorldControllerModelTest
    {
        [Test]
