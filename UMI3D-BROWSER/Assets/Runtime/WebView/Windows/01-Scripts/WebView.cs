...
namespace BrowserDesktop
{
    public class WebView : AbstractUMI3DWebView, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            NotificationHub.Default.Notify(this, ID.FromType<InputNotificationKeys.TextEditionStart>());
        }
        ...
        public void OnPointerExit(PointerEventData eventData)
        {
            ...
            NotificationHub.Default.Notify(this, ID.FromType<InputNotificationKeys.TextEditionStop>());
        }
