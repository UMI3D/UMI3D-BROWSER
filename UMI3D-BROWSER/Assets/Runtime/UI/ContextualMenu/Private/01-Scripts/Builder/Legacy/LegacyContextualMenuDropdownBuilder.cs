...
{
    public class LegacyContextualMenuDropdownBuilder : IDropdownBuilder
    {
        ...
        public LegacyContextualMenuDropdownBuilder(DropdownFactory factory, EnumParameterDto<string> dto)
        {
