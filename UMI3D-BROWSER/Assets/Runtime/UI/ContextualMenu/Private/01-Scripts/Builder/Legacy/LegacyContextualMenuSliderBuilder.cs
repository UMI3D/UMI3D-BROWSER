...
{
    public class LegacyContextualMenuSliderBuilder<T> : ISliderBuilder where T : IComparable
    {
        ...
        public LegacyContextualMenuSliderBuilder(SliderFactory factory, AbstractRangeParameterDto<T> dto)
        {
