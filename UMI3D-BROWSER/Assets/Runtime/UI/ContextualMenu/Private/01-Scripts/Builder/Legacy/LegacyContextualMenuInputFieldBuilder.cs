...
{
    public class LegacyContextualMenuInputFieldBuilder : IInputFieldBuilder
    {
        ...
        public LegacyContextualMenuInputFieldBuilder(InputFieldFactory factory, StringParameterDto dto)
        {
