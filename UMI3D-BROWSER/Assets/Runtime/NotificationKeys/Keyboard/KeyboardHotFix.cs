...
namespace umi3d.browserRuntime.ui.keyboard
{
    public class KeyboardHotFix : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            animationNotifier = NotificationHub.Default.GetNotifier<KeyboardNotificationKeys.AnimationSettings>(
                this            
            );
            ...
            versionNotifier = NotificationHub.Default.GetNotifier<KeyboardNotificationKeys.ChangeVersion>(
                this
            );
