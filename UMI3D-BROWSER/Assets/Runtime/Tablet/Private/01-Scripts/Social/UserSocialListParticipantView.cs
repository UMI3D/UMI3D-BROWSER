...
namespace umi3d.browserRuntime.ui.tablet.social
{
    ...
    public class UserSocialListParticipantView : MonoBehaviour
    {
        TMP_Text _text;
        ...
        {
            if (notification.TryGetInfoT(UserSocialNotificationKeys.UserSocialListSet.NbrParticipant, out int nbrParticipant))
            {
                _text.text = nbrParticipant.ToString();
            }
        }
    }
}